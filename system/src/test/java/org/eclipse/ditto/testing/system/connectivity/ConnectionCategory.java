...
public enum ConnectionCategory {
    ...
    CONNECTION_WITH_PIPELINE_FILTER,
    CONNECTION_WITH_COMBINED_RQL_AND_PIPELINE_FILTER,
    CONNECTION_WITH_EXTRA_FIELDS_AND_PIPELINE_FILTER,
    CONNECTION_WITH_ORIGIN_PIPELINE_FILTER,
